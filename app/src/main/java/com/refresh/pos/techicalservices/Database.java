...
public interface Database {
	...
	boolean updateCategory(String tableName, Object content);

	boolean updateTemp(String tableName, Object content);
	boolean updateTable(String tableName, Object content);
	...
	boolean deleteLine(String tableName,int id);

    boolean deleteTableId(String tableName, int id);
