...
import com.refresh.pos.ui.register.RegisterActivity;
...
public class SplashScreenActivity extends Activity {
	...
	private void initiateCoreApp() {
		...
		CateProductDao cateProductDao=new CateProductDaoAndroid(database);
		SaleDao saleDao = new SaleDaoAndroid(database);
		TableDao tableDao = new TableDaoAndroid(database);
		...
		ProductCategory.setCateProductDao(cateProductDao);
		TableLedger.setTableDao(tableDao);
