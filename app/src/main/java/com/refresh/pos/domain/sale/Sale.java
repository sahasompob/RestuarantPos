...
public class Sale {
	...
	public List<LineItem> getAllLinebyTable(){
		return items;
	}
	...
	public LineItem addLineItem_Temp(Product product, int quantity,String topping_group,String topping,String topping_name,double toppingPrice) {
		...
		LineItem lineItem = new LineItem(1,"gpk1",1,2,3,product,quantity,topping_group,topping,topping_name,toppingPrice,"todaya");
		items.add(lineItem);
		return lineItem;
	}
